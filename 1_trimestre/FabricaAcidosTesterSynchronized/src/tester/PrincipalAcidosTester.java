...
public class PrincipalAcidosTester{
	...
	public static void main(String[] args) {
		...
		MaquinaCCtester cc1 = new MaquinaCCtester("Maquina 4", 3, contenedor);
		MaquinaCCtester cc2 = new MaquinaCCtester("Maquina 5", 4, contenedor);
		MaquinaCCtester cc3 = new MaquinaCCtester("Maquina 6", 5, contenedor);
		
		MaquinaTester testerSC = new MaquinaTester(contenedor);
		MaquinaTester testerCC = new MaquinaTester(contenedor);
